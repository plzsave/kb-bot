...
- [x] 1.2 フィクスチャ Markdown を本番 KB と分離した索引に組み立てる手段を用意する
...
- [x] 2.1 (P) 「古い値を述べる」フィクスチャ doc を作成する
...
- [x] 2.2 (P) 矛盾を突くドリフトケースを評価ケース集に追加する
...
- [x] 3.1 フィクスチャを持つケースだけ隔離索引を検索源に使う配線を入れる
